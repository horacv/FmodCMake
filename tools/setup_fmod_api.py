...
def main():
    ...
    if len(sys.argv) < 5:
        ...
        print("\nExample:")
        print("  python setup_fmod_api.py user@example.com password123 windows 20313")
        print("  python setup_fmod_api.py user@example.com password123 windows 20313 --delete-installer")
        print("\nThis script will:")
